...
import {GlobalEventsManager} from '../../../../components/common/globalevent'
...
export class PieChartDemo {
    ...
    options:any;
    generateOptions(){
      this.options=ChartHelper.getChartOptions(ChartType.pie, true, true, true, undefined, undefined, undefined, false, undefined,16);
    }
